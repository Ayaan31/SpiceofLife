...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="Resources/styles/parents.css">
   ...
   <body>
      <nav>
         ...
         <ul>
            ...
            <li><a href="#"  class = "currentPage">Parents' Place</a></li>
      ...
      <h1 id="title">Parents' Place</h1>
      <h2 id="slogan">Limited Ingredients<br>No Problem</h2>
...
<?php
  ...
  $url = "https://api.edamam.com/api/recipes/v2?type=public&app_id=".urlencode($APP_ID)."&app_key=".urlencode($API_KEY)."&ingr=2-6&health=alcohol-free&mealType=Dinner&mealType=Lunch&dishType=Main%20course&dishType=Salad&dishType=Sandwiches&dishType=Soup&time=10-15";
